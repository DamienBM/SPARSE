...
Im_fft_ph_golfcart_mag_elephant = magnitude_elephant.*exp(1i*phase_golfcart);
Im_fft_ph_elephant_mag_golfcart = magnitude_golfcart.*exp(1i*phase_elephant);

Im_result_ph_golfcart_mag_elephant = ifft2(Im_fft_ph_golfcart_mag_elephant);
Im_result_ph_elephant_mag_golfcart = ifft2(Im_fft_ph_elephant_mag_golfcart);

figure;
imshow(abs(Im_result_ph_golfcart_mag_elephant));

figure;
imshow(abs(Im_result_ph_elephant_mag_golfcart));
